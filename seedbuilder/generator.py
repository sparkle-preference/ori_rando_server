...
def setSeedAndPlaceItems(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters,
                    ...
                    setNonProgressiveMapstones, playerCountIn, balanced, entrance, sharedItems, wild=False, preplaced=[]):
    global random
    global sharedMap
    global sharedList
    sharedMap = {}
...
def placeItemsMulti(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters,
                    modes, flags, starvedMode, preferPathDifficulty,
                    setNonProgressiveMapstones, playerCountIn, balanced, entrance, wild=False, preplaced=[], retries=5):
    global sharedMap
    ...
    placement = placeItems(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones, playerCountIn, playerID, balanced, entrance, 0, wild, preplaced)
    if not placement:
        if preplaced:
            if retries > 0:
                retries -= 1
                ...
                preplaced = []
                print "WARNING: Discarding preplaced options since seed could not be built"
        return placeItemsMulti(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode,
                               ...
                               preferPathDifficulty, setNonProgressiveMapstones, playerCountIn, balanced, entrance, wild, preplaced, retries)
    ...
    while playerID < playerCountIn:
        ...
        if not placement:
            ...
            return placeItemsMulti(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode,
                                   ...
                                   balanced, entrance, wild, preplaced, retries)
        placements.append(placement)

    return placements

def placeItems(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones, playerCountIn, playerIDIn, balancedIn, entrance, depth=0, wild=False, preplaced=[]):
    global costs
    global areas
    global areasReached
    global currentAreas
            ...
            if not assignQueue:
                ...
                if not reservedLocations:
                    ...
                    if depth > playerCount * playerCount:
                        return
                    return placeItems(seed, expPool, hardMode, includePlants, shardsMode, limitkeysMode, cluesMode, noTeleporters, modes, flags, starvedMode, preferPathDifficulty, setNonProgressiveMapstones, playerCount, playerID, balanced, entrance, depth + 1, wild, preplaced)
