...
class WorldFlagLinesTestCase(unittest.TestCase):
    ...
    def test_one_line_per_world_when_they_differ(self):
        lines = main.world_flag_lines(mw_params([{}, {"keyMode": "Shards"}]))
