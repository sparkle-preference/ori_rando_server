...
def flag_status():
    flags = {"BATCH_GRANTS": BATCH_GRANTS, "HIST_ON_PLAYER": HIST_ON_PLAYER, "SPLIT_CACHE": SPLIT_CACHE, "BINGO_V2": BINGO_V2, "CHUNKED_LOGS": CHUNKED_LOGS, "MULTIWORLD": MULTIWORLD}
